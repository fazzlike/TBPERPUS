...
@section('main_register')
    {{-- content --}}
    <main class="main-content  mt-0" style="background-color: #A2CDF4">
        <section class="min-vh-100 mb-8" style="background-color: #A2CDF4">
            <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
                style="background-image: url('../assets/img/curved-images/curved14.jpg'); background-color:#A2CDF4">
                        ...
                        <div class="card z-index-0">
                            ...
                            <div class="card-body">
                                <form role="form text-left" action="{{ route('register_user') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                        <input type="text" style="color: #6C99C3" class="form-control" name="name" placeholder="Name"
                                            aria-label="Name" aria-describedby="email-addon">
                                    </div>
                                    <div class="mb-3">
                                        <input type="email" style="color: #6C99C3" class="form-control" name="email" placeholder="Email"
                                            aria-label="Email" aria-describedby="email-addon">
                                    </div>
                                    <div class="mb-3">
                                        <input type="password" style="color: #6C99C3" class="form-control" name="password"
                                    ...
                                    <div class="form-check form-check-info text-left">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefault" style="color: #6C99C3">
                                            I agree the <a href="javascript:;" class=" font-weight-bolder" style="color: #6C99C3">Terms
                                                and Conditions</a>
                                        </label>
                                    </div>
                                    <div class="cf-turnstile" data-sitekey="<YOUR_SITE_KEY>"></div>
                                    <div class="text-center">
                                        <button type="submit" class="btn bg-blue w-100 my-4 mb-2" style="color: #A2CDF4">Sign
                                            up</button>
                                    </div>
                                    <p class="text-sm mt-3 mb-0" style="color: #6C99C3">Already have an account? <a href="{{ route('login') }}"
                                            class="" style="color: #A2CDF4">Sign in</a></p>
                                </form>
