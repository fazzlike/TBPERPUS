        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ request()->is('petugas/dashboard') ? 'active' : '' }}"
                    href="{{ route('dashboard_petugas') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            style="fill: {{ request()->is('petugas/dashboard') ? 'rgb(255, 255, 255)' : 'rgb(0, 0, 1)' }} ;transform: ;msFilter:;">
                            <path
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('petugas/data_pinjam') ? 'active' : '' }}"
